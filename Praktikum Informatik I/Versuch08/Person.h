 ...
 * die fuer die Buecherei relevant sind, dies beinhaltet:
 * 	- Name
 * 	- Geburtsdatum
 *
 */
...
public:
	 ...
	 *
	 * \return std::string: gibt den Namen der Person zurueck
	 */
	 ...
	 *
	 * \return Datum: gibt das Geburtsdautm der Person zurueck
	 */
